    ...
    if(formkey.currentState!.validate()){
      showDialog(
        ...
        if (_profilePhoto != null) {
          profilePhotoUrl = await Controllers.uploadImage(_profilePhoto!, "leafCustomer/${widget.currentUser!.uid}/profile_photo.jpg");
        }
        else{
        ...
        if(widget.currentUser!=null && profilePhotoUrl!=null){
          ...
          DatabaseReference userRef=FirebaseDatabase.instance.ref().child("leafCustomer");
