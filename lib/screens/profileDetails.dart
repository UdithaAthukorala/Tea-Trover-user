    ...
    if (formkey.currentState!.validate()) {
      ...
      if (_profilePhoto != null) {
        profilePhotoUrl = await Controllers.uploadImage(
          _profilePhoto!,
          "leafCustomer/${widget.currentUser!.uid}/profile_photo.jpg",
        );
      } else {
      ...
      if (widget.currentUser != null && profilePhotoUrl != null) {
        ...
        FirebaseDatabase.instance.ref().child("leafCustomer");
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            Padding(
              padding: EdgeInsets.fromLTRB(5, (MediaQuery.of(context).size.height) / 6, 5, 5),
            ),
            Padding(
